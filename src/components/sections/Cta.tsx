...
export default function CTA() {
  const stats = [
    ...
    { value: '25+', label: 'Years Experience', icon: Zap },
    { value: '24/7', label: 'Customer Care', icon: Sparkles },
  ];
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Each piece tells a story of artisan craftsmanship and timeless elegance. Find
                jewelry as unique as you are, handmade with love and attention to detail.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Featured in leading fashion magazines and trusted by jewelry lovers worldwide
                </p>
                <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
                  {/* Magazine/Publication logos placeholders */}
                  {[...Array(5)].map((_, i) => (
                    <div
                      key={i}
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Guaranteed craftsmanship with lifetime repair service
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Custom engraving and bespoke design services available
              </p>
            </div>
          </div>
        </div>
